...
class Ui_frmmain(object):
    def setupUi(self, frmmain):
        ...
        self.label.setGeometry(QtCore.QRect(10, 10, 691, 81))
        ...
        self.label_2.setGeometry(QtCore.QRect(10, 30, 611, 81))
        ...
        self.bttnbrowse.setGeometry(QtCore.QRect(10, 110, 99, 41))
        self.bttnbrowse.setObjectName("bttnbrowse")
        self.lbldatafolder = QtWidgets.QLabel(self.groupBox)
        self.lbldatafolder.setGeometry(QtCore.QRect(120, 120, 341, 16))
        ...
        self.bttnsettings = QtWidgets.QPushButton(self.centralwidget)
        self.bttnsettings.setGeometry(QtCore.QRect(710, 10, 81, 61))
        self.bttnsettings.setObjectName("bttnsettings")
...
"Trainer Script"))
        self.bttnsettings.setText(_translate("frmmain", "Settings..."))
